...
TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_BACKGROUND_COLOR:-'#0c0c0c'}
...
if [ -z $TMUX_POWERLINE_LEFT_STATUS_SEGMENTS ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info #78a9ff #0c0c0c" \
		"hostname #0c0c0c #78a9ff" \
		#"ifstat 30 255" \
		#"ifstat_sys 30 255" \
		"lan_ip #78a9ff #0c0c0c" \
		#"wan_ip 24 255" \
		"vcs_branch #0c0c0c #78a9ff" \
		#"vcs_compare 60 255" \
		#"vcs_staged 64 255" \
		#"vcs_modified 9 255" \
		#"vcs_others 245 0" \
...
if [ -z $TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"xkb_layout 125 117" \
		"date_day #0c0c0c #78a9ff" \
		"date #0c0c0c #78a9ff ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		"time #0c0c0c #78a9ff ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
