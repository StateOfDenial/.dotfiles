...
### Step 2: Search!
- You can use your handy dandy `Grep`, `Glob`, and `LS` tools to to find what 
...
```
Remember: You're providing templates and examples developers can adapt. 
Show them how it's been done successfully before.
